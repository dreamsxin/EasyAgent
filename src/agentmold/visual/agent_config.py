...
def resolve_mode(
    ...
    ``log_level`` remains accepted for callers generated by older EasyAgent
    versions, but the visual lab intentionally ignores console logging and uses
    its timeline, execution map, and trace views for observability.
    """
    del log_level
